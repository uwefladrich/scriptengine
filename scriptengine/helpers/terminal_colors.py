...
COLORTABLE = {
    'standard': {
        ...
        'BOLD': '\033[01m', 'DIM': '\033[02m', 'UNDERLINE': '\033[04m', 'REVERSE': '\033[07m',
        'STRIKETHROUGH': '\033[09m', 'INVISIBLE': '\033[08m',
        ...
        'BG_ORANGE': '\033[43m', 'BG_BLUE': '\033[44m', 'BG_PURPLE': '\033[45m',
...
def set_theme(theme):
    ...
    """
    global ACTIVE_THEME
    if not theme in COLORTABLE.keys():
        raise RuntimeError(f'{__name__}: Invalid theme: {theme}')
    ACTIVE_THEME = theme

    # Clean all present color settings
    for color in {color for table in COLORTABLE for color in COLORTABLE[table]}:
