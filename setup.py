...
setuptools.setup(
    ...
    entry_points={
        ...
        "scriptengine.tasks": [
            ...
            "copy = scriptengine.tasks.base.files.copy:Copy",
            ...
            "link = scriptengine.tasks.base.files.link:Link",
            "make_dir = scriptengine.tasks.base.files.make_dir:MakeDir",
            "move = scriptengine.tasks.base.files.move:Move",
            "remove = scriptengine.tasks.base.files.remove:Remove",
            ...
            "base.copy = scriptengine.tasks.base.files.copy:Copy",
            ...
            "base.link = scriptengine.tasks.base.files.link:Link",
            "base.make_dir = scriptengine.tasks.base.files.make_dir:MakeDir",
            "base.move = scriptengine.tasks.base.files.move:Move",
            "base.remove = scriptengine.tasks.base.files.remove:Remove",
